...
### base_analyzer.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [base_analyzer.Sample.csproj](../base_analyzer.Sample/base_analyzer.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 
